...
# Descarga e instalación robusta del paquete draw.io-desktop
RUN curl -fL https://github.com/jgraph/drawio-desktop/releases/download/v22.0.3/drawio-x64-22.0.3.deb -o drawio.deb && \
    dpkg -i drawio.deb || (apt-get install -yf && dpkg -i drawio.deb) && \
    rm drawio.deb

# Copia scripts, archivo de entrada y plantillas al contenedor
